...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! u u~ > u d~ b e- ve~ b~
      PD(IPROC)=PD(IPROC-1) + U1*UX2
      IPROC=IPROC+1  ! c c~ > u d~ b e- ve~ b~
      PD(IPROC)=PD(IPROC-1) + C1*CX2
      IPROC=IPROC+1  ! u u~ > c s~ b e- ve~ b~
      PD(IPROC)=PD(IPROC-1) + U1*UX2
      IPROC=IPROC+1  ! c c~ > c s~ b e- ve~ b~
      PD(IPROC)=PD(IPROC-1) + C1*CX2
      IPROC=IPROC+1  ! u u~ > u d~ b mu- vm~ b~
      PD(IPROC)=PD(IPROC-1) + U1*UX2
      IPROC=IPROC+1  ! c c~ > u d~ b mu- vm~ b~
      PD(IPROC)=PD(IPROC-1) + C1*CX2
      IPROC=IPROC+1  ! u u~ > c s~ b mu- vm~ b~
      PD(IPROC)=PD(IPROC-1) + U1*UX2
      IPROC=IPROC+1  ! c c~ > c s~ b mu- vm~ b~
      PD(IPROC)=PD(IPROC-1) + C1*CX2
