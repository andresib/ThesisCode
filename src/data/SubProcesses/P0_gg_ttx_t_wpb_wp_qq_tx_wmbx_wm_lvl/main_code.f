...
C|                                                                       |
C|    Class: B                                                           |
C|    particle in ECS : 7(missing)    6(visible)                         |
...
C+-----------------------------------------------------------------------+
        ...
        call block_d(x,n_var,first_d_3_4, second_d_3_4,-3)
        call block_stat(1,'D-3')
        if (jac.le.0d0) return

C       ++++++++++++           
        call block_d(x,n_var,5, -3, -4)
        call block_stat(2,'D-5')
        if (jac.le.0d0) return

        call class_b(7,6,-1)
        call block_stat(3,'b-7')
        if (jac.le.0d0) return
...
C+-----------------------------------------------------------------------+
        ...
        call block_e(x,n_var,4,3,5,-3,-4)
        call block_stat(1,'E-4')
        if (jac.le.0d0) return

        call class_b(7,6,-1)
        call block_stat(2,'b-7')
        if (jac.le.0d0) return
...
C+-----------------------------------------------------------------------+
        ...
        call fuse(3,4,-3)
        call block_stat(1,'1-3')
        if (jac.le.0d0) return

C       ++++++++++++           
        call fuse(5,-3,-4)
        call block_stat(2,'1-5')
        if (jac.le.0d0) return
...
C|                                                                       |
C|    Class: B                                                           |
C|    particle in ECS : 7(missing)    a(fuse)                            |
C|    blob linked are generated by :-4                                   |
C|                                                                       |
C|                                                                       |
C+-----------------------------------------------------------------------+
...
C       ++++++++++++           
        ...
        call fuse(6,8,9)
        call block_stat(3,'2-6')
        if (jac.le.0d0) return

        call class_b(7,9,-2)
        call block_stat(4,'b-7')
        if (jac.le.0d0) return
