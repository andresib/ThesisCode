...
C     ----------
      ...
      CALL VVV1_1(W(1,1),W(1,2),GC_4,ZERO, ZERO, W(1,13))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,12),W(1,7),W(1,13),GC_5,AMP(1))
      CALL FFV1_1(W(1,7),W(1,1),GC_5,MT, WT, W(1,14))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,12),W(1,14),W(1,2),GC_5,AMP(2))
      CALL FFV1_2(W(1,12),W(1,1),GC_5,MT, WT, W(1,15))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,15),W(1,7),W(1,2),GC_5,AMP(3))
