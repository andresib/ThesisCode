...
##process.MessageLogger.cerr.PATSummaryTables = cms.untracked.PSet(limit = cms.untracked.int32(0))
...
process.pSemileptonic = cms.Path(base_path + process.countPatJetsSemileptonicPF + process.semilepMuonsPF + process.semilepElectronsPF + process.countPatLeptonsSemileptonicPF)
