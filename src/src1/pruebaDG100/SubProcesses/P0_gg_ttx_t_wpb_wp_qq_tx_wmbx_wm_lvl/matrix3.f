...
C     ----------
      ...
      CALL OXXXXX(P(0,5),MB,NHEL(5),+1*IC(5),W(1,6))
      CALL FFV2_1(W(1,6),W(1,5),GC_16,MT, WT, W(1,7))
      CALL OXXXXX(P(0,6),ZERO,NHEL(6),+1*IC(6),W(1,8))
      CALL IXXXXX(P(0,7),ZERO,NHEL(7),-1*IC(7),W(1,9))
      CALL FFV2_3(W(1,9),W(1,8),GC_16,MW, WW, W(1,10))
      CALL IXXXXX(P(0,8),MB,NHEL(8),-1*IC(8),W(1,11))
      CALL FFV2_2(W(1,11),W(1,10),GC_16,MT, WT, W(1,12))
      CALL FFV1_3(W(1,1),W(1,2),GC_1,ZERO, ZERO, W(1,13))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,12),W(1,7),W(1,13),GC_2,AMP(1))
      CALL FFV1_3(W(1,1),W(1,2),GC_5,ZERO, ZERO, W(1,14))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,12),W(1,7),W(1,14),GC_5,AMP(2))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_21,GC_23,MZ, WZ, W(1,15))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,12),W(1,7),W(1,15),GC_22,GC_23,AMP(3))
      JAMP(1)=-AMP(1)+1./6.*AMP(2)-AMP(3)
      JAMP(2)=+1./2.*(-AMP(2))
