// -*- C++ -*-
//
// Package:    PruebaMWWithGrid
// Class:      PruebaMWWithGrid
// 
/**\class PruebaMWWithGrid PruebaMWWithGrid.cc Analyzers/PruebaMWWithGrid/src/PruebaMWWithGrid.cc
...
//
using namespace std;
class PruebaMWWithGrid : public edm::EDAnalyzer {
public:
  explicit PruebaMWWithGrid(const edm::ParameterSet&);
  ~PruebaMWWithGrid();
...
//
PruebaMWWithGrid::PruebaMWWithGrid(const edm::ParameterSet& iConfig)
...
PruebaMWWithGrid::~PruebaMWWithGrid()
{
...
void
PruebaMWWithGrid::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void
PruebaMWWithGrid::selectingBestPerm(std::string weights)
{
  ifstream is_Weights;
...
void 
PruebaMWWithGrid::beginRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
void 
PruebaMWWithGrid::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
PruebaMWWithGrid::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
PruebaMWWithGrid::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
PruebaMWWithGrid::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(PruebaMWWithGrid);
